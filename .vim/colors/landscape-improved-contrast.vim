" A fork of the 'landscape' color scheme with improved contrast.
" Original: https://github.com/itchyny/landscape.vim

set background=dark
highlight clear

let g:colors_name = 'landscape-improved-contrast'
if exists('syntax_on')
  syntax reset
endif

highlight Normal gui=none guifg=White guibg=Black
highlight Comment term=none ctermfg=Gray ctermbg=none gui=none guifg=Gray
